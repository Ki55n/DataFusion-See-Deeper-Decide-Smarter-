...
- Globe Plots: Ideal for visualizing geographic data, such as customer or sales data distributed across different countries or regions. Use for questions like "Which countries have the most customers?" or "Where are products being sold the most?" or "Show the customer count or sales volume per country on a world map."
...
7. Geographic Data (e.g., "Where are customers located by country?" or "How are product sales distributed globally?" - Globe Plots)

Provide your response in the following format:
Recommended Visualization: [Chart type or "None"]. ONLY use the following names: bar, horizontal_bar, line, pie, scatter, globe, none
